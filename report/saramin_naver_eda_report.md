...
## VI. 5대 직무별 필수 요구사항 vs 우대사항 TF-IDF 및 워드클라우드 세부 심층 EDA (겹침 방지 정밀 쿼리)

본 섹션은 사람인 채용공고 5,000건 데이터셋(`recruit_processed.db`)에서 5대 직무별 공고 제목(title)과 필수 요건(requirement), 우대 사항(preferential) 텍스트를 공백으로 결합한 후, **학력 용어 및 서술어/조미어(대한, 자격요건, 가능하신, 담당자 등)를 추가 배제하고 글자 겹침을 100% 방지**하여 추출한 **TF-IDF 상위 30개 키워드 서브플롯**과 **워드클라우드 서브플롯** 분석 결과입니다.

### 기획/전략 직무: 필수 요구사항 vs 우대사항 텍스트 심층 분석 (겹침 방지 정밀 쿼리)
...
#### [기획/전략 데이터 분석 인사이트]
불용어 추가 정제(대한, 자격요건, 가능하신, 담당자 등 배제) 후 **[기획/전략]** 직무 분석 결과, 필수 요건에서는 **사업, 사업기획, 역량, 예정자, 문서** 기술이 서류 합격의 핵심 조건으로 나타났으며, 우대사항 영역에서는 **프로젝트, 사업, 글로벌, 영어, 활용** 기술이 최종 우대 가산점 요소로 작동합니다.

---

### 인사/노무 직무: 필수 요구사항 vs 우대사항 텍스트 심층 분석 (겹침 방지 정밀 쿼리)
...
#### [인사/노무 데이터 분석 인사이트]
불용어 추가 정제(대한, 자격요건, 가능하신, 담당자 등 배제) 후 **[인사/노무]** 직무 분석 결과, 필수 요건에서는 **인사, hr, 총무, 대학졸업, 인사총무** 기술이 서류 합격의 핵심 조건으로 나타났으며, 우대사항 영역에서는 **인사, hr, 총무, 회계, 인사총무** 기술이 최종 우대 가산점 요소로 작동합니다.

---

### 회계/재무 직무: 필수 요구사항 vs 우대사항 텍스트 심층 분석 (겹침 방지 정밀 쿼리)
...
#### [회계/재무 데이터 분석 인사이트]
불용어 추가 정제(대한, 자격요건, 가능하신, 담당자 등 배제) 후 **[회계/재무]** 직무 분석 결과, 필수 요건에서는 **회계, 대학졸업, 세무, 재무, 경력직** 기술이 서류 합격의 핵심 조건으로 나타났으며, 우대사항 영역에서는 **회계, 자격증, 경력직, 세무, 재무** 기술이 최종 우대 가산점 요소로 작동합니다.

---

### 마케팅 직무: 필수 요구사항 vs 우대사항 텍스트 심층 분석 (겹침 방지 정밀 쿼리)
...
#### [마케팅 데이터 분석 인사이트]
불용어 추가 정제(대한, 자격요건, 가능하신, 담당자 등 배제) 후 **[마케팅]** 직무 분석 결과, 필수 요건에서는 **마케팅, 마케터, 브랜드, 콘텐츠, 대학졸업** 기술이 서류 합격의 핵심 조건으로 나타났으며, 우대사항 영역에서는 **마케팅, 마케터, 브랜드, 콘텐츠, 글로벌** 기술이 최종 우대 가산점 요소로 작동합니다.

---

### 데이터분석가/AI엔지니어 직무: 필수 요구사항 vs 우대사항 텍스트 심층 분석 (겹침 방지 정밀 쿼리)
...
불용어 추가 정제(대한, 자격요건, 가능하신, 담당자 등 배제) 후 **[데이터분석가/AI엔지니어]** 직무 분석 결과, 필수 요건에서는 **개발자, ai, java, 백엔드, 대학졸업** 기술이 서류 합격의 핵심 조건으로 나타났으며, 우대사항 영역에서는 **개발자, ai, 프로젝트, 시스템, 백엔드** 기술이 최종 우대 가산점 요소로 작동합니다.

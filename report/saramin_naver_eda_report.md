...
## VI. 5대 직무별 필수 요구사항 vs 우대사항 TF-IDF 및 워드클라우드 세부 심층 EDA (실무 툴/역량 중심 정밀 쿼리)

본 섹션은 사람인 채용공고 5,000건 데이터셋(`recruit_processed.db`)에서 5대 직무별 공고 제목(title)과 필수 요건(requirement), 우대 사항(preferential) 텍스트를 공백으로 결합한 후, **직무 대표 명칭(회계, 재무, 마케팅, 인사, 노무, 기획, 데이터, AI 등)을 불용어로 추가 제거하여 실무 툴 및 세부 직무 역량이 1위 대형 텍스트로 도출되도록 정제**한 **TF-IDF 상위 30개 키워드 서브플롯**과 **워드클라우드 서브플롯** 분석 결과입니다.

### 기획/전략 직무: 필수 요구사항 vs 우대사항 텍스트 심층 분석 (대표 직무명 제거 & 실무 툴/역량 선명화)

![기획/전략 TF-IDF & WordCloud](../images/plot11_plan_tfidf_wordcloud.png)

#### [필수 자격 요건 TOP 10 실무 툴/역량 TF-IDF 가중치 테이블]
| 순위 | 필수 핵심 실무 역량 | TF-IDF 가중치 |
|:---:|:---|:---:|
| 1 | 사업 | 86.59 |
| 2 | 사업기획 | 68.60 |
| 3 | 역량 | 61.07 |
...
#### [우대사항 TOP 10 실무 툴/역량 TF-IDF 가중치 테이블]
| 순위 | 우대 핵심 실무 툴 | TF-IDF 가중치 |
|:---:|:---|:---:|
| 1 | 프로젝트 | 63.63 |
| 2 | 사업 | 61.61 |
| 3 | 글로벌 | 57.08 |
...
#### [기획/전략 데이터 분석 인사이트]
직무 대표 단어(회계, 마케팅, 인사 등)의 독점 왜곡 현상을 제거한 결과, **[기획/전략]** 직무의 필수 요구사항에서는 **사업, 사업기획, 역량, 프로젝트, 문서** 실무 역량이 서류 통과의 주요 임계값으로 명확히 도출되었으며, 우대사항 영역에서는 **프로젝트, 사업, 글로벌, 영어, 활용** 실무 툴 및 전문 기술이 최종 면접 가산점의 핵심 우대 요소로 선명히 드러납니다.

---

### 인사/노무 직무: 필수 요구사항 vs 우대사항 텍스트 심층 분석 (대표 직무명 제거 & 실무 툴/역량 선명화)
...
#### [인사/노무 데이터 분석 인사이트]
직무 대표 단어(회계, 마케팅, 인사 등)의 독점 왜곡 현상을 제거한 결과, **[인사/노무]** 직무의 필수 요구사항에서는 **hr, 총무, 실무, 인사총무, 경력직** 실무 역량이 서류 통과의 주요 임계값으로 명확히 도출되었으며, 우대사항 영역에서는 **hr, 총무, 인사총무, 경영지원, 경력직** 실무 툴 및 전문 기술이 최종 면접 가산점의 핵심 우대 요소로 선명히 드러납니다.

---

### 회계/재무 직무: 필수 요구사항 vs 우대사항 텍스트 심층 분석 (대표 직무명 제거 & 실무 툴/역량 선명화)
...
#### [회계/재무 데이터 분석 인사이트]
직무 대표 단어(회계, 마케팅, 인사 등)의 독점 왜곡 현상을 제거한 결과, **[회계/재무]** 직무의 필수 요구사항에서는 **세무, 경력직, 재무회계, 실무, 활용** 실무 역량이 서류 통과의 주요 임계값으로 명확히 도출되었으며, 우대사항 영역에서는 **자격증, 세무, 경력직, 재무회계, 더존** 실무 툴 및 전문 기술이 최종 면접 가산점의 핵심 우대 요소로 선명히 드러납니다.

---

### 마케팅 직무: 필수 요구사항 vs 우대사항 텍스트 심층 분석 (대표 직무명 제거 & 실무 툴/역량 선명화)
...
#### [마케팅 데이터 분석 인사이트]
직무 대표 단어(회계, 마케팅, 인사 등)의 독점 왜곡 현상을 제거한 결과, **[마케팅]** 직무의 필수 요구사항에서는 **브랜드, 콘텐츠, 홍보, 퍼포먼스, 글로벌** 실무 역량이 서류 통과의 주요 임계값으로 명확히 도출되었으며, 우대사항 영역에서는 **브랜드, 콘텐츠, 글로벌, 퍼포먼스, 광고** 실무 툴 및 전문 기술이 최종 면접 가산점의 핵심 우대 요소로 선명히 드러납니다.

---

### 데이터분석가/AI엔지니어 직무: 필수 요구사항 vs 우대사항 텍스트 심층 분석 (대표 직무명 제거 & 실무 툴/역량 선명화)
...
직무 대표 단어(회계, 마케팅, 인사 등)의 독점 왜곡 현상을 제거한 결과, **[데이터분석가/AI엔지니어]** 직무의 필수 요구사항에서는 **ai, java, 백엔드, 설계, 시스템** 실무 역량이 서류 통과의 주요 임계값으로 명확히 도출되었으며, 우대사항 영역에서는 **ai, 프로젝트, 시스템, 백엔드, java** 실무 툴 및 전문 기술이 최종 면접 가산점의 핵심 우대 요소로 선명히 드러납니다.

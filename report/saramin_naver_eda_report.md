...
## VI. 5대 직무별 필수 요구사항 vs 우대사항 TF-IDF 및 워드클라우드 세부 심층 EDA

본 섹션은 사람인 채용공고 5,000건 데이터셋(`recruit_processed.db`)에서 5대 직무별 공고 제목(title)과 필수 요건(requirement), 우대 사항(preferential) 텍스트를 공백으로 결합한 후, HTML 태그 및 불용어를 고속 전처리하여 추출한 **TF-IDF 상위 30개 키워드 서브플롯**과 **워드클라우드 서브플롯** 분석 결과입니다.

### 기획/전략 직무: 필수 요구사항 vs 우대사항 텍스트 심층 분석
...
#### [기획/전략 데이터 분석 인사이트]
**[기획/전략]** 직무 분석 결과, 필수 자격 요건에서는 **4년, 대학교졸업, 3년, 무관, 5년** 키워드가 핵심 서류 진입 장벽(Threshold)으로 나타났으며, 우대사항 영역에서는 **또는, 경험자, 모집, 있으신, 사업** 키워드가 면접 가산점 및 채용 결정의 주요 요소로 작동하고 있습니다.

---

### 인사/노무 직무: 필수 요구사항 vs 우대사항 텍스트 심층 분석
...
#### [인사/노무 데이터 분석 인사이트]
**[인사/노무]** 직무 분석 결과, 필수 자격 요건에서는 **3년, 인사, 4년, hr, 대학교졸업** 키워드가 핵심 서류 진입 장벽(Threshold)으로 나타났으며, 우대사항 영역에서는 **인사, hr, 모집, 경험자, 총무** 키워드가 면접 가산점 및 채용 결정의 주요 요소로 작동하고 있습니다.

---

### 회계/재무 직무: 필수 요구사항 vs 우대사항 텍스트 심층 분석
...
#### [회계/재무 데이터 분석 인사이트]
**[회계/재무]** 직무 분석 결과, 필수 자격 요건에서는 **회계, 3년, 4년, 무관, 학력무관** 키워드가 핵심 서류 진입 장벽(Threshold)으로 나타났으며, 우대사항 영역에서는 **회계, 모집, 경험자, 자격증, 있으신** 키워드가 면접 가산점 및 채용 결정의 주요 요소로 작동하고 있습니다.

---

### 마케팅 직무: 필수 요구사항 vs 우대사항 텍스트 심층 분석
...
#### [마케팅 데이터 분석 인사이트]
**[마케팅]** 직무 분석 결과, 필수 자격 요건에서는 **마케팅, 3년, 4년, 무관, 대학교졸업** 키워드가 핵심 서류 진입 장벽(Threshold)으로 나타났으며, 우대사항 영역에서는 **마케팅, 마케터, 브랜드, 콘텐츠, 있으신** 키워드가 면접 가산점 및 채용 결정의 주요 요소로 작동하고 있습니다.

---

### 데이터분석가/AI엔지니어 직무: 필수 요구사항 vs 우대사항 텍스트 심층 분석
...
**[데이터분석가/AI엔지니어]** 직무 분석 결과, 필수 자격 요건에서는 **3년, 개발자, 4년, ai, 학력무관** 키워드가 핵심 서류 진입 장벽(Threshold)으로 나타났으며, 우대사항 영역에서는 **개발자, ai, 또는, 경험자, 있으신** 키워드가 면접 가산점 및 채용 결정의 주요 요소로 작동하고 있습니다.

...
## VI. 5대 직무별 필수 요구사항 vs 우대사항 TF-IDF 및 워드클라우드 세부 심층 EDA (학력/조미어 배제 정밀 쿼리)

본 섹션은 사람인 채용공고 5,000건 데이터셋(`recruit_processed.db`)에서 5대 직무별 공고 제목(title)과 필수 요건(requirement), 우대 사항(preferential) 텍스트를 공백으로 결합한 후, **학력 관련 용어(대졸, 4년제, 학력무관 등) 및 서술어/조미어(또는, 있는, 있으신, 경험자, 모집 등)를 전면 제거**하여 순수한 실무 기술/역량 키워드 중심으로 재추출한 **TF-IDF 상위 30개 키워드 서브플롯**과 **워드클라우드 서브플롯** 분석 결과입니다.

### 기획/전략 직무: 필수 요구사항 vs 우대사항 텍스트 심층 분석 (학력/조미어 배제)

![기획/전략 TF-IDF & WordCloud](../images/plot11_plan_tfidf_wordcloud.png)

#### [필수 자격 요건 TOP 10 TF-IDF 가중치 테이블 (학력/조미어 배제)]
...
#### [우대사항 TOP 10 TF-IDF 가중치 테이블 (학력/조미어 배제)]
...
#### [기획/전략 데이터 분석 인사이트]
학력 관련 용어(대졸, 4년제 등) 및 서술어(또는, 있는, 있으신 등)를 전면 배제하고 정밀 재집계한 결과, **[기획/전략]** 직무의 필수 자격 항목에서는 **사업, 자격요건, 사업기획, 역량, 프로젝트** 스킬이 서류 합격의 핵심 기술 임계값으로 드러났으며, 우대사항 영역에서는 **프로젝트, 사업, 담당자, 글로벌, 영어** 기술이 면접 가산점의 핵심 경쟁력으로 작용하고 있습니다.

---

### 인사/노무 직무: 필수 요구사항 vs 우대사항 텍스트 심층 분석 (학력/조미어 배제)
...
#### [인사/노무 데이터 분석 인사이트]
학력 관련 용어(대졸, 4년제 등) 및 서술어(또는, 있는, 있으신 등)를 전면 배제하고 정밀 재집계한 결과, **[인사/노무]** 직무의 필수 자격 항목에서는 **인사, hr, 대학졸업, 총무, 담당자** 스킬이 서류 합격의 핵심 기술 임계값으로 드러났으며, 우대사항 영역에서는 **인사, hr, 총무, 담당자, 회계** 기술이 면접 가산점의 핵심 경쟁력으로 작용하고 있습니다.

---

### 회계/재무 직무: 필수 요구사항 vs 우대사항 텍스트 심층 분석 (학력/조미어 배제)
...
#### [회계/재무 데이터 분석 인사이트]
학력 관련 용어(대졸, 4년제 등) 및 서술어(또는, 있는, 있으신 등)를 전면 배제하고 정밀 재집계한 결과, **[회계/재무]** 직무의 필수 자격 항목에서는 **회계, 대학졸업, 재무, 세무, 담당자** 스킬이 서류 합격의 핵심 기술 임계값으로 드러났으며, 우대사항 영역에서는 **회계, 자격증, 담당자, 경력직, 세무** 기술이 면접 가산점의 핵심 경쟁력으로 작용하고 있습니다.

---

### 마케팅 직무: 필수 요구사항 vs 우대사항 텍스트 심층 분석 (학력/조미어 배제)
...
#### [마케팅 데이터 분석 인사이트]
학력 관련 용어(대졸, 4년제 등) 및 서술어(또는, 있는, 있으신 등)를 전면 배제하고 정밀 재집계한 결과, **[마케팅]** 직무의 필수 자격 항목에서는 **마케팅, 마케터, 브랜드, 콘텐츠, 대한** 스킬이 서류 합격의 핵심 기술 임계값으로 드러났으며, 우대사항 영역에서는 **마케팅, 마케터, 브랜드, 콘텐츠, 글로벌** 기술이 면접 가산점의 핵심 경쟁력으로 작용하고 있습니다.

---

### 데이터분석가/AI엔지니어 직무: 필수 요구사항 vs 우대사항 텍스트 심층 분석 (학력/조미어 배제)
...
학력 관련 용어(대졸, 4년제 등) 및 서술어(또는, 있는, 있으신 등)를 전면 배제하고 정밀 재집계한 결과, **[데이터분석가/AI엔지니어]** 직무의 필수 자격 항목에서는 **개발자, ai, java, 백엔드, 대학졸업** 스킬이 서류 합격의 핵심 기술 임계값으로 드러났으며, 우대사항 영역에서는 **개발자, ai, 프로젝트, 시스템, 백엔드** 기술이 면접 가산점의 핵심 경쟁력으로 작용하고 있습니다.
